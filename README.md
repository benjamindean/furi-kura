...
```
wget https://github.com/benjamindean/furi-kura/releases/download/v0.0.5-beta/furi-kura_0.0.5-1_all.deb
sudo dpkg -i furi-kura_0.0.5-1_all.deb
```
...
```
wget https://github.com/benjamindean/furi-kura/archive/v0.0.5-beta.zip
unzip v0.0.5-beta.zip && cd v0.0.5-beta
sudo make install
```
